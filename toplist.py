...
ingredientDic['hazelnut'] = IngredientBook('hazelnut', '', '', '', 'pinus cembroides', 'almond')
...
ingredientDic['pickled onion'] = IngredientBook('pickled onion', healthy, vegetarian, vegan, mexican, greek),
ingredientDic['pig cheeks'] = IngredientBook('pig cheeks', healthy, vegetarian, vegan, mexican, greek),
ingredientDic['pigeon'] = IngredientBook('pigeon', healthy, vegetarian, vegan, mexican, greek),
ingredientDic['pigeon peas'] = IngredientBook('pigeon peas', healthy, vegetarian, vegan, mexican, greek),
ingredientDic['pine nut'] = IngredientBook('pine nut', healthy, vegetarian, vegan, mexican, greek),
ingredientDic['pineapple'] = IngredientBook('pineapple', healthy, vegetarian, vegan, mexican, greek),
ingredientDic['pineapple juice'] = IngredientBook('pineapple juice', healthy, vegetarian, vegan, mexican, greek),
ingredientDic['pinto bean'] = IngredientBook('pinto bean', healthy, vegetarian, vegan, mexican, greek),
ingredientDic['piri-piri'] = IngredientBook('piri-piri', healthy, vegetarian, vegan, mexican, greek),
ingredientDic['pistachio'] = IngredientBook('pistachio', healthy, vegetarian, vegan, mexican, greek),
ingredientDic['pita bread'] = IngredientBook('pita bread', healthy, vegetarian, vegan, mexican, greek),
ingredientDic['plaice'] = IngredientBook('plaice', healthy, vegetarian, vegan, mexican, greek),
ingredientDic['plain flour'] = IngredientBook('plain flour', healthy, vegetarian, vegan, mexican, greek),
ingredientDic['plantain'] = IngredientBook('plantain', healthy, vegetarian, vegan, mexican, greek),
ingredientDic['plum'] = IngredientBook('plum', healthy, vegetarian, vegan, mexican, greek),
ingredientDic['polenta'] = IngredientBook('polenta', healthy, vegetarian, vegan, mexican, greek),
ingredientDic['pollock'] = IngredientBook('pollock', healthy, vegetarian, vegan, mexican, greek),
ingredientDic['pomegranate'] = IngredientBook('pomegranate', healthy, vegetarian, vegan, mexican, greek),
ingredientDic['pomegranate juice'] = IngredientBook('pomegranate juice', healthy, vegetarian, vegan, mexican, greek),
ingredientDic['poppy seeds'] = IngredientBook('poppy seeds', healthy, vegetarian, vegan, mexican, greek),
ingredientDic['porcini'] = IngredientBook('porcini', healthy, vegetarian, vegan, mexican, greek),
ingredientDic['pork'] = IngredientBook('pork', healthy, vegetarian, vegan, mexican, greek),
ingredientDic['pork belly'] = IngredientBook('pork belly', healthy, vegetarian, vegan, mexican, greek),
ingredientDic['pork chop'] = IngredientBook('pork chop', healthy, vegetarian, vegan, mexican, greek),
ingredientDic['pork fillet'] = IngredientBook('pork fillet', healthy, vegetarian, vegan, mexican, greek),
ingredientDic['pork leg'] = IngredientBook('pork leg', healthy, vegetarian, vegan, mexican, greek),
ingredientDic['pork loin'] = IngredientBook('pork loin', healthy, vegetarian, vegan, mexican, greek),
ingredientDic['pork mince'] = IngredientBook('pork mince', healthy, vegetarian, vegan, mexican, greek),
ingredientDic['pork sausages'] = IngredientBook('pork sausages', healthy, vegetarian, vegan, mexican, greek),
ingredientDic['pork shoulder'] = IngredientBook('pork shoulder', healthy, vegetarian, vegan, mexican, greek),
ingredientDic['pork spare rib'] = IngredientBook('pork spare rib', healthy, vegetarian, vegan, mexican, greek),
ingredientDic['portobello mushrooms'] = IngredientBook('portobello mushrooms', healthy, vegetarian, vegan, mexican, greek),
ingredientDic['potato'] = IngredientBook('potato', healthy, vegetarian, vegan, mexican, greek),
ingredientDic['potato wedges'] = IngredientBook('potato wedges', healthy, vegetarian, vegan, mexican, greek),
ingredientDic['poultry'] = IngredientBook('poultry', healthy, vegetarian, vegan, mexican, greek),
ingredientDic['praline'] = IngredientBook('praline', healthy, vegetarian, vegan, mexican, greek),
ingredientDic['prawn'] = IngredientBook('prawn', healthy, vegetarian, vegan, mexican, greek),
ingredientDic['prawn crackers'] = IngredientBook('prawn crackers', healthy, vegetarian, vegan, mexican, greek),
ingredientDic['preserves'] = IngredientBook('preserves', healthy, vegetarian, vegan, mexican, greek),
ingredientDic['prosciutto'] = IngredientBook('prosciutto', healthy, vegetarian, vegan, mexican, greek),
ingredientDic['prune'] = IngredientBook('prune', healthy, vegetarian, vegan, mexican, greek),
ingredientDic['prune juice'] = IngredientBook('prune juice', healthy, vegetarian, vegan, mexican, greek),
ingredientDic['pudding rice'] = IngredientBook('pudding rice', healthy, vegetarian, vegan, mexican, greek),
ingredientDic['pulled pork'] = IngredientBook('pulled pork', healthy, vegetarian, vegan, mexican, greek),
ingredientDic['pumpkin'] = IngredientBook('pumpkin', healthy, vegetarian, vegan, mexican, greek),
ingredientDic['pumpkin seed'] = IngredientBook('pumpkin seed', healthy, vegetarian, vegan, mexican, greek),
ingredientDic['quail'] = IngredientBook('quail', healthy, vegetarian, vegan, mexican, greek),
ingredientDic['quails egg'] = IngredientBook('quails egg', healthy, vegetarian, vegan, mexican, greek),
ingredientDic['quark'] = IngredientBook('quark', healthy, vegetarian, vegan, mexican, greek),
ingredientDic['quinoa'] = IngredientBook('quinoa', healthy, vegetarian, vegan, mexican, greek),
...
ingredientDic['truffle oil'] = IngredientBook('truffle oil', 'healthy', 'vegetarian', 'vegan', 'mexican', 'greek')
ingredientDic['turkey'] = IngredientBook('turkey', 'healthy', 'vegetarian', 'vegan', 'mexican', 'greek')
ingredientDic['turkey breast'] = IngredientBook('turkey breast', 'healthy', 'vegetarian', 'vegan', 'mexican', 'greek')
ingredientDic['turkey mince'] = IngredientBook('turkey mince', 'healthy', 'vegetarian', 'vegan', 'mexican', 'greek')
ingredientDic['turmeric'] = IngredientBook('turmeric', 'healthy', 'vegetarian', 'vegan', 'mexican', 'greek')
ingredientDic['turnip'] = IngredientBook('turnip', 'healthy', 'vegetarian', 'vegan', 'mexican', 'greek')
ingredientDic['unleavened bread'] = IngredientBook('unleavened bread', 'healthy', 'vegetarian', 'vegan', 'mexican', 'greek')
ingredientDic['vacherin cheese'] = IngredientBook('vacherin cheese', 'healthy', 'vegetarian', 'vegan', 'mexican', 'greek')
ingredientDic['vanilla essence'] = IngredientBook('vanilla essence', 'healthy', 'vegetarian', 'vegan', 'mexican', 'greek')
ingredientDic['vanilla extract'] = IngredientBook('vanilla extract', 'healthy', 'vegetarian', 'vegan', 'mexican', 'greek')
ingredientDic['veal'] = IngredientBook('veal', 'healthy', 'vegetarian', 'vegan', 'mexican', 'greek')
ingredientDic['vegetable oil'] = IngredientBook('vegetable oil', 'healthy', 'vegetarian', 'vegan', 'mexican', 'greek')
ingredientDic['vegetable stock'] = IngredientBook('vegetable stock', 'healthy', 'vegetarian', 'vegan', 'mexican', 'greek')
ingredientDic['vegetable'] = IngredientBook('vegetable', 'healthy', 'vegetarian', 'vegan', 'mexican', 'greek')
ingredientDic['vegetarian sausage'] = IngredientBook('vegetarian sausage', 'healthy', 'vegetarian', 'vegan', 'mexican', 'greek')
ingredientDic['venison'] = IngredientBook('venison', 'healthy', 'vegetarian', 'vegan', 'mexican', 'greek')
ingredientDic['vermicelli'] = IngredientBook('vermicelli', 'healthy', 'vegetarian', 'vegan', 'mexican', 'greek')
ingredientDic['vermouth'] = IngredientBook('vermouth', 'healthy', 'vegetarian', 'vegan', 'mexican', 'greek')
ingredientDic['vine leaves'] = IngredientBook('vine leaves', 'healthy', 'vegetarian', 'vegan', 'mexican', 'greek')
ingredientDic['vinegar'] = IngredientBook('vinegar', 'healthy', 'vegetarian', 'vegan', 'mexican', 'greek')
ingredientDic['vodka'] = IngredientBook('vodka', 'healthy', 'vegetarian', 'vegan', 'mexican', 'greek')
ingredientDic['walnut'] = IngredientBook('walnut', 'healthy', 'vegetarian', 'vegan', 'mexican', 'greek')
ingredientDic['walnut oil'] = IngredientBook('walnut oil', 'healthy', 'vegetarian', 'vegan', 'mexican', 'greek')
ingredientDic['wasabi'] = IngredientBook('wasabi', 'healthy', 'vegetarian', 'vegan', 'mexican', 'greek')
...
ingredientDic['whole wheat pasta'] = IngredientBook('whole wheat pasta', 'healthy', 'vegetarian', 'vegan', 'mexican', 'greek')u'wild duck', 'healthy', 'vegetarian', 'vegan', 'mexican', 'greek')
